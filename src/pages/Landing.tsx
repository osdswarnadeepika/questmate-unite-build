      ...
      <div className="pt-24 pb-16 px-4 sm:px-6 lg:px-8">
        <div className="max-w-4xl mx-auto text-center">
          <h1 className="text-5xl sm:text-6xl lg:text-7xl font-bold text-gray-900 mb-6 leading-tight">
            Find your next
            <span className="text-purple-600 block">hackathon teammate</span>
          </h1>
        ...
        <div className="max-w-6xl mx-auto">
          <div className="grid md:grid-cols-3 gap-8">
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Connect with like-minded builders and creators ready to collaborate.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Smart algorithms match you with teammates based on skills and goals.</p>
            </div>
            ...
            <div className="text-center p-6">
              ...
              <p className="text-gray-600">Build your reputation and earn credentials for successful collaborations.</p>
            </div>
          </div>
        </div>
      </div>
